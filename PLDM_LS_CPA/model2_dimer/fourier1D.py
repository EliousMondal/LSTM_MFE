...
# plt.legend(frameon=False, fontsize=20, handlelength=0.75)
plt.xlabel(r"ω(cm⁻¹)", fontsize=20)
plt.ylabel(r"R$^{1}$(ω)", fontsize=20)
...
plt.xticks(np.array([-0.5, -0.25, 0.0, 0.25, 0.5]) * 1e3, fontsize=20)
